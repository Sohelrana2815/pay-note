  ...
  return (
    <FieldSet>
      <div className="flex justify-between items-center gap-2">
        <FieldContent>
          <FieldTitle className="text-lg font-semibold">Items</FieldTitle>
      ...
      <FieldGroup>
        {items.map((item, index) => (
          <div
            key={item.id}
            className="flex flex-col md:flex-row items-center justify-center gap-2 p-3 border rounded-md"
          >
            {/* Item Name */}
            <Controller
              control={control}
